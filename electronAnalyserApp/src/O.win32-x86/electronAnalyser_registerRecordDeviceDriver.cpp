...
/* Generated from ../O.Common/electronAnalyser.dbd */
...
static const char * const deviceSupportNames[80] = {
    "devAiSoft",
    "devAiSoftRaw",
    "devTimestampAI",
    "devAiGeneralTime",
...
static const dset * const devsl[80] = {
    pvar_dset_devAiSoft,
...
epicsShareExtern void (*pvar_func_electronAnalyserRegister)(void);
...
int electronAnalyser_registerRecordDeviceDriver(DBBASE *pbase)
{
    registerRecordTypes(pbase, 30, recordTypeNames, rtl);
    registerDevices(pbase, 80, deviceSupportNames, devsl);
    ...
    (*pvar_func_electronAnalyserRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"electronAnalyser_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    electronAnalyser_registerRecordDeviceDriver(*iocshPpdbbase);
}
