...
namespace SESWrapperNS
{
  ...
  *
  * @see WRP_CheckAnalyzerRegion(), WRP_SetAnalyzerRegion()
  */
  typedef struct WAnalyzerRegion
  {
    ...
    double highEnergy_; /*!< Specifies the high-end kinetic energy (eV) for swept mode acquisition. */
    double lowEnergy_; /*!< Specifies the low-end kinetic energy (eV) for swept mode acquisition. */
